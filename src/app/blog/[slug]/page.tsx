...
const blogContent: Record<string, React.ReactNode> = {
  'm65-jacket-guide': (
    <>
      ...
      <p style={{ textAlign: 'center', marginTop: '48px' }}>
        <Link href="/products" style={{ display: 'inline-block', padding: '14px 48px', border: '1px solid rgba(26,26,26,.4)', fontSize: '.65rem', letterSpacing: '.4em', fontWeight: 300, color: '#1a1a1a' }}>
          查看全系列工装夹克
        </Link>
      </p>
    </>
  ...
  'brand-story': (
    <>
      <p>2011年，重庆解放碑附近，一间不足50平方米的小工作室里，三个二十多岁的年轻人正在讨论如何做出一件真正像样的美式工装夹克。</p>
      <p>十八年后，那三个年轻人的品牌——马登工装——已经拥有全国7家实体门店，70+线上店铺，和135万抖音粉丝。但他们说，从来没有想过要"成功"。只是想做好一件夹克而已。</p>

      <h2>起点：一件哈灵顿夹克</h2>
      <p>2011年，中国的美式复古工装市场几乎是空白。想买一件像样的哈灵顿夹克，要么买国外进口（贵且难买），要么买国内仿制（做工粗糙、版型走样）。</p>
      ...
      <h2>扩张：从线上到实体</h2>
      <p>2021年，品牌创立十周年，马登在重庆开出了第一家实体店。这是一个关键节点——实体店意味着消费者可以摸到面料、看到版型、感受做工，而不只是看图购买。</p>
    ...
    <>
      ...
      <section style={{ position: 'relative', height: '60vh', minHeight: '400px', display: 'flex', alignItems: 'flex-end', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '48px', maxWidth: '900px' }}>
          <div style={{ display: 'flex', gap: '16px', marginBottom: '16px' }}>
            <span style={{ fontSize: '.55rem', letterSpacing: '.3em', color: '#1a1a1a', fontWeight: 300 }}>{post.category}</span>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '80px 48px 140px' }}>
        ...
        <div style={{ marginTop: '80px', paddingTop: '40px', borderTop: '1px solid rgba(0,0,0,.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Link href="/products" style={{ fontSize: '.65rem', letterSpacing: '.3em', color: '#1a1a1a', fontWeight: 300 }}>
            探索产品系列 →
          </Link>
        </div>
      </div>
