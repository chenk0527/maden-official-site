            ...
            <div key={product.id} className="r product-card">
              ...
              <div style={{ padding: '24px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                  ...
                  <span style={{ fontSize: '.7rem', color: '#e8391a', fontWeight: 300 }}>{product.price}</span>
                </div>
                <p style={{ fontSize: '.8rem', lineHeight: 1.7, fontWeight: 200, color: 'rgba(245,237,232,.4)', marginBottom: '20px' }}>
                  {product.description}
                </p>
