      ...
      <section style={{ padding: '0 48px 140px' }}>
        <div className="stores-3col">
          {[
            ...
            <div key={item.title} className="r" style={{ padding: '32px', background: '#230808' }}>
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.2rem', fontWeight: 300, color: '#e8391a', marginBottom: '16px' }}>{item.title}</h3>
              <p style={{ fontSize: '.85rem', lineHeight: 1.9, fontWeight: 200, color: 'rgba(245,237,232,.4)', whiteSpace: 'pre-line' }}>{item.text}</p>
            </div>
          ))}
        </div>
      </section>
