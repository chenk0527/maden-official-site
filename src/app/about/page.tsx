  ...
  return (
    <>
            ...
            {brands.map((b, i) => (
              <div key={b.name} className="r brand-card" style={{
                ...
                <span style={{
                  ...
                  color: '#1a1a1a', opacity: 0.12, lineHeight: 1,
                  userSelect: 'none',
                }}>
      ...
      <section style={{ padding: '120px 48px', background: '#0e0e0e', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative' }}>
            {/* 中间横线 */}
            <div style={{ position: 'absolute', top: '50%', left: 0, right: 0, height: '1px', background: 'rgba(26,26,26,.12)', transform: 'translateY(-50%)' }} />
                  ...
                  {c.row === 'top' ? (
                    ...
                    <>
                      ...
                      <div className="charity-node-top">
                        ...
                        <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#1a1a1a', opacity: 0.7, border: '2px solid #0e0e0e', outline: '1px solid rgba(26,26,26,.4)', margin: '0 auto' }} />
                      </div>
                    </>
                  ) : (
                    /* 下排：圆点+年份在上，内容在下 */
                    <>
                      <div className="charity-node-bottom">
                        <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#1a1a1a', opacity: 0.7, border: '2px solid #0e0e0e', outline: '1px solid rgba(26,26,26,.4)', margin: '0 auto 8px' }} />
      ...
      <style>{`
        ...
        .brand-card:hover { border-color: rgba(26,26,26,.4) !important; }
