    ...
    <>
      ...
      <section style={{ padding: '40px 48px 80px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h2 className="r" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.8rem', fontWeight: 300, color: '#cc2200', letterSpacing: '.08em', marginBottom: '12px' }}>
            校园招聘
          </h2>
          <p className="r" style={{ fontSize: '.75rem', fontWeight: 200, color: 'rgba(240,235,232,.3)', marginBottom: '32px', letterSpacing: '.05em' }}>
            Campus Recruitment
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {campusPositions.map(pos => (
              <div key={pos.title} className="job-card" style={{ border: '1px solid rgba(204,34,0,.15)', background: '#120808', padding: '24px 28px', transition: 'border-color .3s' }}>
                <div className="job-card-inner" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    <div style={{ color: '#cc2200', opacity: 0.6, flexShrink: 0 }}>
                      <pos.Icon size={28} color="currentColor" strokeWidth={1.2} />
                    </div>
                    <div>
                      <h3 style={{ fontSize: '.95rem', fontWeight: 400, marginBottom: '6px', color: 'rgba(240,235,232,.85)' }}>{pos.title}</h3>
                      <p style={{ fontSize: '.72rem', fontWeight: 300, color: 'rgba(240,235,232,.35)' }}>
          ...
          <div style={{ marginTop: '32px', textAlign: 'center' }}>
            <a href={CAMPUS_FORM_URL} className="apply-btn" style={{ display: 'inline-block', padding: '14px 48px', border: '1px solid #b22222', color: '#cc2200', fontSize: '.8rem', letterSpacing: '.15em', fontWeight: 300, textDecoration: 'none', transition: 'all .3s' }}>
              立即投递
            </a>
          </div>
        </div>
      ...
      <section style={{ padding: '40px 48px 80px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: '32px', textAlign: 'center' }}>
            <a href={SOCIAL_FORM_URL} className="apply-btn" style={{ display: 'inline-block', padding: '14px 48px', border: '1px solid #b22222', color: '#cc2200', fontSize: '.8rem', letterSpacing: '.15em', fontWeight: 300, textDecoration: 'none', transition: 'all .3s' }}>
              立即投递
            </a>
          </div>
        </div>
      ...
      <section style={{ padding: '0 48px 140px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div className="r" style={{ background: '#120808', padding: '60px', textAlign: 'center', borderTop: '1px solid rgba(204,34,0,.15)', borderBottom: '1px solid rgba(204,34,0,.15)' }}>
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.4rem', fontWeight: 300, color: '#cc2200', marginBottom: '12px', letterSpacing: '.05em' }}>
              简历投递
            </p>
            <p style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(240,235,232,.3)', lineHeight: 1.8 }}>
      ...
      <style>{`
        .job-card:hover { border-color: rgba(204,34,0,.4) !important; }
