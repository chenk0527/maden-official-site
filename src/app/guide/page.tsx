  ...
  return (
    <>
      ...
      <section style={{ paddingTop: '180px', padding: '180px 48px 80px', textAlign: 'center' }}>
        ...
        <p className="r" style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(26,26,26,.4)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <article style={{ padding: '40px 48px 140px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          <h2 className="r" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, color: '#1a1a1a', letterSpacing: '.05em', marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid rgba(26,26,26,.2)' }}>
            一、什么是美式复古工装（阿美咔叽/Americana）
          </h2>
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(26,26,26,.6)', marginBottom: '20px' }}>
            <strong style={{ color: '#1a1a1a' }}>阿美咔叽（Amekaji）</strong>是"American Casual"的日语音译，字面意为"美式休闲"。但这个词远不只是字面意思——它代表了一种起源于美国、经由日本人精炼后再传回亚洲的复古穿衣哲学。
          </p>
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(26,26,26,.6)', marginBottom: '20px' }}>
            <strong style={{ color: '#1a1a1a' }}>Americana</strong>则是更广泛的概念，泛指一切具有美国文化属性的事物：蓝领工人的工装、西部牛仔的牛仔裤、二战军人的军服、常青藤校园的学院风……这些服装类型在20世纪中叶的美国日常中随处可见，如今却成了全球复古爱好者趋之若鹜的经典。
          </p>
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(26,26,26,.6)' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          {[
            ...
            <div key={item.title} className="r" style={{ marginBottom: '48px', padding: '32px', background: '#ebe8e3', borderLeft: '2px solid rgba(26,26,26,.3)' }}>
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.6rem', fontWeight: 300, color: '#1a1a1a', letterSpacing: '.05em', marginBottom: '16px' }}>
                {item.title}
              </h3>
              {item.content.split('\n\n').map((para, i) => (
                <p key={i} style={{ fontSize: '.9rem', lineHeight: 2, fontWeight: 200, color: 'rgba(26,26,26,.6)', marginBottom: '12px' }}>
                  {para}
                </p>
              ))}
            </div>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(26,26,26,.6)', marginBottom: '24px' }}>
            工装搭配的核心原则只有一个：<strong style={{ color: '#1a1a1a' }}>宽松 + 同色系 + 细节呼应</strong>。
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '32px' }}>
            {[
              ...
              <div key={block.title} className="r" style={{ padding: '24px', background: '#ebe8e3' }}>
                <h4 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.2rem', fontWeight: 300, color: '#1a1a1a', marginBottom: '16px' }}>
                  {block.title}
                </h4>
                <ul>
                  {block.items.map((item, i) => (
                    <li key={i} style={{ fontSize: '.85rem', lineHeight: 1.8, fontWeight: 200, color: 'rgba(26,26,26,.5)', marginBottom: '8px', paddingLeft: '16px', position: 'relative' }}>
        ...
        {/* FAQ */}
        <section>
          <h2 className="r" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, color: '#1a1a1a', letterSpacing: '.05em', marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid rgba(26,26,26,.2)' }}>
            常见问题 FAQ
          </h2>
          {faqItems.map((item, i) => (
            <div key={i} className="r" style={{ marginBottom: '32px', paddingBottom: '32px', borderBottom: '1px solid rgba(0,0,0,.06)' }}>
              <h3 style={{ fontSize: '1rem', fontWeight: 400, letterSpacing: '.03em', marginBottom: '12px', color: '#1a1a1a' }}>
                Q: {item.q}
              </h3>
              <p style={{ fontSize: '.85rem', lineHeight: 1.9, fontWeight: 200, color: 'rgba(26,26,26,.5)' }}>
                A: {item.a}
              </p>
            </div>
          ))}
        ...
        {/* CTA */}
        <div className="r" style={{ marginTop: '80px', textAlign: 'center', padding: '60px 32px', background: '#ebe8e3', borderTop: '1px solid rgba(26,26,26,.2)' }}>
          <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, marginBottom: '16px', letterSpacing: '.05em' }}>
            准备好开始你的工装之旅了吗？
          </h3>
          <p style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(26,26,26,.4)', marginBottom: '32px' }}>
