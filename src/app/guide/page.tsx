  ...
  return (
    <>
      ...
      <section style={{ paddingTop: '180px', padding: '180px 48px 80px', textAlign: 'center' }}>
        ...
        <p className="r" style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(245,237,232,.4)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <article style={{ padding: '40px 48px 140px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          <h2 className="r" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, color: '#e8391a', letterSpacing: '.05em', marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid rgba(232,57,26,.2)' }}>
            一、什么是美式复古工装（阿美咔叽/Americana）
          </h2>
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(245,237,232,.6)', marginBottom: '20px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(245,237,232,.6)' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          {[
            ...
            <div key={item.title} className="r" style={{ marginBottom: '48px', padding: '32px', background: '#230808', borderLeft: '2px solid rgba(232,57,26,.3)' }}>
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.6rem', fontWeight: 300, color: '#e8391a', letterSpacing: '.05em', marginBottom: '16px' }}>
                {item.title}
              </h3>
              {item.content.split('\n\n').map((para, i) => (
                <p key={i} style={{ fontSize: '.9rem', lineHeight: 2, fontWeight: 200, color: 'rgba(245,237,232,.6)', marginBottom: '12px' }}>
                  {para}
                </p>
              ))}
            </div>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(245,237,232,.6)', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '32px' }}>
            {[
              ...
              <div key={block.title} className="r" style={{ padding: '24px', background: '#230808' }}>
                <h4 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.2rem', fontWeight: 300, color: '#e8391a', marginBottom: '16px' }}>
                  {block.title}
                </h4>
                <ul>
                  {block.items.map((item, i) => (
                    <li key={i} style={{ fontSize: '.85rem', lineHeight: 1.8, fontWeight: 200, color: 'rgba(245,237,232,.5)', marginBottom: '8px', paddingLeft: '16px', position: 'relative' }}>
                      <span style={{ position: 'absolute', left: 0, color: '#e8391a' }}>·</span>
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        {/* FAQ */}
        <section>
          <h2 className="r" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, color: '#e8391a', letterSpacing: '.05em', marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid rgba(232,57,26,.2)' }}>
            常见问题 FAQ
          </h2>
          {faqItems.map((item, i) => (
            <div key={i} className="r" style={{ marginBottom: '32px', paddingBottom: '32px', borderBottom: '1px solid rgba(232,57,26,.12)' }}>
              <h3 style={{ fontSize: '1rem', fontWeight: 400, letterSpacing: '.03em', marginBottom: '12px', color: '#e8e4df' }}>
                Q: {item.q}
              </h3>
              <p style={{ fontSize: '.85rem', lineHeight: 1.9, fontWeight: 200, color: 'rgba(245,237,232,.5)' }}>
                A: {item.a}
              </p>
            </div>
          ))}
        ...
        {/* CTA */}
        <div className="r" style={{ marginTop: '80px', textAlign: 'center', padding: '60px 32px', background: '#230808', borderTop: '1px solid rgba(232,57,26,.2)' }}>
          <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2rem', fontWeight: 300, marginBottom: '16px', letterSpacing: '.05em' }}>
            准备好开始你的工装之旅了吗？
          </h3>
          <p style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(245,237,232,.4)', marginBottom: '32px' }}>
