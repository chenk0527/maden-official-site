  ...
  return (
    <>
      ...
      <section style={{ paddingTop: '180px', padding: '180px 48px 80px', textAlign: 'center' }}>
        ...
        <p className="r" style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(30,25,20,.4)', maxWidth: '600px', margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <article style={{ padding: '40px 48px 140px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(30,25,20,.6)', marginBottom: '20px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(30,25,20,.6)' }}>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          {[
            ...
            <div key={item.title} className="r" style={{ marginBottom: '48px', padding: '32px', background: '#ebe8e3', borderLeft: '2px solid rgba(26,26,26,.3)' }}>
              ...
              {item.content.split('\n\n').map((para, i) => (
                <p key={i} style={{ fontSize: '.9rem', lineHeight: 2, fontWeight: 200, color: 'rgba(30,25,20,.6)', marginBottom: '12px' }}>
                  {para}
                </p>
              ))}
            </div>
        ...
        <section style={{ marginBottom: '80px' }}>
          ...
          <p style={{ fontSize: '.9rem', lineHeight: 2.2, fontWeight: 200, color: 'rgba(30,25,20,.6)', marginBottom: '24px' }}>
              ...
              <div key={block.title} className="r" style={{ padding: '24px', background: '#ebe8e3' }}>
                ...
                <ul>
                  {block.items.map((item, i) => (
                    <li key={i} style={{ fontSize: '.85rem', lineHeight: 1.8, fontWeight: 200, color: 'rgba(30,25,20,.5)', marginBottom: '8px', paddingLeft: '16px', position: 'relative' }}>
        ...
        <section>
          ...
          {faqItems.map((item, i) => (
            <div key={i} className="r" style={{ marginBottom: '32px', paddingBottom: '32px', borderBottom: '1px solid rgba(255,255,255,.04)' }}>
              ...
              <p style={{ fontSize: '.85rem', lineHeight: 1.9, fontWeight: 200, color: 'rgba(30,25,20,.5)' }}>
                A: {item.a}
              </p>
            </div>
          ))}
        ...
        <div className="r" style={{ marginTop: '80px', textAlign: 'center', padding: '60px 32px', background: '#ebe8e3', borderTop: '1px solid rgba(26,26,26,.2)' }}>
          ...
          <p style={{ fontSize: '.85rem', fontWeight: 200, color: 'rgba(30,25,20,.4)', marginBottom: '32px' }}>
