...
export const products: Product[] = [
  {
    ...
    category: '外套',
    price: '¥199起',
    image: '/images/ali-harrington.jpg',
    alt: '马登工装 哈灵顿G9夹克',
  ...
  },
  {
    ...
    category: '外套',
    price: '¥249起',
    image: '/images/ali-wax-jacket.jpg',
    alt: '马登工装 油蜡猎装夹克',
  ...
  },
  {
    ...
    category: '衬衫',
    price: '¥99起',
    image: '/images/ali-cuban-shirt.jpg',
    alt: '马登工装 古巴领短袖衬衫',
  ...
  },
  {
    ...
    category: '卫衣',
    price: '¥119起',
    image: '/images/ali-hoodie-deck.jpg',
    alt: '马登工装 甲板连帽卫衣',
  ...
  },
  {
    ...
    category: '羽绒',
    price: '¥299起',
    image: '/images/ali-down-vest.jpg',
    alt: '马登工装 羽绒马甲背心',
...
export const lookbookItems = [
  { image: '/images/ali-harrington.jpg', alt: '马登工装 哈灵顿夹克穿搭', label: '造型 01 · 哈灵顿夹克' },
  { image: '/images/ali-wax-jacket.jpg', alt: '马登工装 油蜡猎装穿搭', label: '造型 02 · 油蜡猎装' },
  { image: '/images/ali-jeans.jpg', alt: '马登工装 赤耳牛仔穿搭', label: '造型 03 · 赤耳牛仔' },
  { image: '/images/ali-sweater.jpg', alt: '马登工装 提花毛衣穿搭', label: '造型 04 · 提花毛衣' },
  { image: '/images/ali-gorpcore.jpg', alt: '马登工装 冲锋衣穿搭', label: '造型 05 · 山系机能' },
  { image: '/images/ali-coat.jpg', alt: '马登工装 牛角扣大衣穿搭', label: '造型 06 · 毛呢大衣' },
  { image: '/images/ali-ma1.jpg', alt: '马登工装 MA-1飞行夹克穿搭', label: '造型 07 · MA-1飞行' },
  { image: '/images/ali-halfzip.jpg', alt: '马登工装 灯芯绒半拉链穿搭', label: '造型 08 · 灯芯绒' },
]
...
export const shopChannels = [
  ...
  { name: '得物', sub: '马登官方', href: '#' },
  { name: '小红书', sub: '马登工装旗舰店', href: '#' },
