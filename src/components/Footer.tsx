...
export default function Footer() {
  return (
    <footer style={{ padding: '80px 48px 40px', borderTop: '1px solid rgba(0,0,0,.1)' }}>
            ...
            <div style={{ display: 'flex', gap: '20px', marginTop: '28px' }}>
              {socialLinks.map(({ href, label, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  title={label}
                  style={{ color: 'rgba(26,26,26,.5)', transition: 'color .3s' }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#1a1a1a')}
                  onMouseLeave={e => (e.currentTarget.style.color = 'rgba(26,26,26,.5)')}
                >
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', opacity: 0.7 }}>
                  <IconPin size={16} color="rgba(26,26,26,.9)" />
                ...
                >
                  <IconMail size={16} color="rgba(26,26,26,.9)" />
